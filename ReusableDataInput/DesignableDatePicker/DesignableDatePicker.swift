...
@IBDesignable public class DesignableDatePicker: InputView {
    // MARK: - Controls
    ...
    @objc public var datePicker: UIDatePicker { pickerInputViewController.datePicker }
    ...
    @objc public var date: NSDate? { pickerInputViewController.selectedDate }
